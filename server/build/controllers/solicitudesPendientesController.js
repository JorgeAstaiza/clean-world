...
class SolicitudesPendientesController {
    listSolicitudes(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const solicitudes = yield database_1.default.query('select u.nombre, u.apellido, d.ciudad, d.direccion,d.departamento, v.idvisita, v.fecha, v.hora, v.foto_residuos, v.foto_residuos_dos from usuario as u inner join generador as g on u.id_email_usuario = g.usuario_id_email_usuario inner join direccion as d on g.id_email_generador = d.generador_id_email_generador inner join visita as v on d.iddireccion = v.direccion_iddireccion where v.estado = "proceso";');
